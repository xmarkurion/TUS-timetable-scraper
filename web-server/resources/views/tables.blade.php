...
<body class="text-center" background="black">
<table class="text-center table table-dark table-sm">
    <tr>
        <th>ID</th>
        <th>Name</th>
        <th>Viscount</th>
    ...
    @foreach ($timee as $r)
        <tr>
            ...
            <td>
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action">{{$r->viscount}}</a>
                </div>
            </td>
            <td>{{$r->updated_at}}</td>
        </tr>
